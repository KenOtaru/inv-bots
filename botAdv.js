...
class EnhancedDerivTradingBot {
    constructor(token, config = {}) {
        ...
        this.filterNum = 2;
        this.consecutiveWins = 0; // Added to track consecutive wins
    ...
    handleTickUpdate(tick) {
     ...
     handleProposal(response) {
        ...
        if (response.proposal) {
            ...
            console.log(`25 Current StayedIn Digit Count: ${this.stayedInArray25[15]} (${currentDigitCount2})`);
            ...
            console.log(`
                StayedIn Analysis: 
                n Array: ${appearedOnceArray} (${appearedOnceArray.length})
            ...
            if (!this.tradeInProgress) {
                ...
                if(this.consecutiveLosses < 1) {
                    ...
                    //Trade Execution Filter
                    if (
                        (appearedOnceArray.includes(currentDigitCount2))
                        && appearedOnceArray[0] !== currentDigitCount 
                        && 
                    ...
                    if (
                        (appearedOnceArray.includes(currentDigitCount2))
                        && 
                        this.tradedDigitArray[this.tradedDigitArray.length - 1] !== currentDigitCount
                        && 
                        this.stayedInArray25[15] > 0
                        ) 
                        {
    ...
    handleTradeResult(contract) {
        ...
        if (won) {
            ...
            //     console.log('10 consecutive wins! Stake reset to initial stake.');
            // }
        ...
        this.tradeExecuted = false; // Reset after trade is completed
