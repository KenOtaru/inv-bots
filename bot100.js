...
class EnhancedDerivTradingBot {
     ...
     handleProposal(response) {
        ...
        if (response.proposal) {
            ...
            if (!this.tradeInProgress) {
                ...
                if (appearedOnceArray.length < this.filterNum) {
    ...
    async sendEmailSummary() {
        ...
        const mailOptions = {
            ...
            subject: 'R100_k5%Accumulator Trading Bot - Summaryy',
            text: summaryText
        };
    ...
    async sendLossEmail() {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'R100_k5%Accumulator Trading Bot - Summary',
            text: summaryText
        };
    ...
    async sendErrorEmail(errorMessage) {
        ...
        const mailOptions = {from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'R100_k5%Accumulator Trading Bot - Error Report',
