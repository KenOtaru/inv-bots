...
class EnhancedDerivTradingBot {
     ...
     handleProposal(response) {
        ...
        if (response.proposal) {
            ...
            if (!this.tradeExecuted) {
                ...
                //     this.filterNum = 1;
                // }
                // if (appearedOnceArray1.length > 1) {
                //     this.filterNum = 2;
                // }
                if (appearedOnceArray1.length > 2) {
                    this.filterNum = 3;
                }
                if (appearedOnceArray1.length > 3) {
                    this.filterNum = 4;
                }
                if (appearedOnceArray1.length > 4) {
                    this.filterNum = 5;
                }
            }
            ...
            if (!this.tradeInProgress) {
                ...
                if (appearedOnceArray.length > 11) {
                    if ((appearedOnceArray.includes(currentDigitCount2))
                        && 
                        this.stayedInArray25[15] > 3
                        ) 
                        {
    ...
    async sendEmailSummary() {
        ...
        const mailOptions = {
            ...
            subject: '2k5%Accumulator Trading Bot - Summary',
            text: summaryText
        };
    ...
    async sendErrorEmail(errorMessage) {
        ...
        const mailOptions = {from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: '2k5%Accumulator Trading Bot - Error Report',
