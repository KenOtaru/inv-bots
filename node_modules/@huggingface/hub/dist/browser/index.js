...
async function datasetInfo(params) {
  ...
  const response = await (params.fetch || fetch)(
    `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/datasets/${params.name}?${search.toString()}`,
    {
      headers: {
        ...accessToken ? { Authorization: `Bearer ${accessToken}` } : {},
...
async function modelInfo(params) {
  ...
  const response = await (params.fetch || fetch)(
    `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/models/${params.name}?${search.toString()}`,
    {
      headers: {
        ...accessToken ? { Authorization: `Bearer ${accessToken}` } : {},
        Accepts: "application/json"
...
async function spaceInfo(params) {
  ...
  const response = await (params.fetch || fetch)(
    `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/spaces/${params.name}?${search.toString()}`,
    {
      headers: {
        ...accessToken ? { Authorization: `Bearer ${accessToken}` } : {},
        Accepts: "application/json"
