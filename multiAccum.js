...
class EnhancedDigitDifferTradingBot {
    ...
    async sendEmailSummary() {
        ...
        const mailOptions = {
            ...
            subject: 'Random_Accumulator_Multi_Asset_Bot - Summary',
            text: summaryText
        };
    ...
    async sendLossEmail(asset) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'Random_Accumulator_Multi_Asset_Bot - Loss Alert',
            text: summaryText
        };
    ...
    async sendErrorEmail(errorMessage) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'Random_Accumulator_Multi_Asset_Bot - Error Report',
