...
class BayesianEngine {
     ...
     */
    initializeAssetPrior(asset, alpha = 10, beta = 1) {
    ...
    initializePatternPrior(patternId) {
        if (!this.priors.patternSuccess[patternId]) {
            this.priors.patternSuccess[patternId] = new BetaDistribution(5, 1);
        }
    }
    ...
    initializeRegimePrior(regime) {
        if (!this.priors.regimeWinProb[regime]) {
            this.priors.regimeWinProb[regime] = new BetaDistribution(5, 1);
        }
    }
