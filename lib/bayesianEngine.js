...
class BayesianEngine {
     ...
     */
    initializeAssetPrior(asset, alpha = 19, beta = 1) {
    ...
    initializeGrowthRatePrior(growthRate) {
        ...
        if (!this.priors.growthRateSuccess[key]) {
            this.priors.growthRateSuccess[key] = new BetaDistribution(19, 1);
        }
    }
    ...
    initializePatternPrior(patternId) {
        if (!this.priors.patternSuccess[patternId]) {
            this.priors.patternSuccess[patternId] = new BetaDistribution(19, 1);
        }
    }
    ...
    initializeRegimePrior(regime) {
        if (!this.priors.regimeWinProb[regime]) {
            this.priors.regimeWinProb[regime] = new BetaDistribution(19, 1);
        }
    }
