...
class KellyCalculator {
     ...
     */
    calculateOptimalGrowthRate(winProbability, targetTicks = 10, minGrowth = 0.01, maxGrowth = 0.05) {
    ...
    /**
     * Calculate optimal take profit amount
     * For accumulators, we target a specific number of ticks (e.g., 10-20)
     * Take Profit = Stake * ((1 + growthRate)^ticks - 1)
     */
    calculateTakeProfit(stake, growthRate, targetTicks = 15) {
        const multiplier = Math.pow(1 + growthRate, targetTicks);
