...
class EnhancedDigitDifferTradingBot {
    ...
    placeTrade(asset, predictedDigit) {
        ...
        const predictedParity = predictedDigit === 0 ? 'DIGITEVEN' : 'DIGITODD';

        this.xDigit = predictedParity;

        console.log(`[${asset}] 🚀 Placing trade for digit: ${predictedParity} | Stake: ${this.currentStake.toFixed(2)}`);
        const request = {
            buy: 1,
    ...
    logTradingSummary(asset) {
        ...
        console.log(`[${asset}] Prediction Type: ${this.xDigit}`);
    ...
    async sendEmailSummary() {
        ...
        const mailOptions = {
            ...
            subject: 'Random Even/Odd Multi_Asset_Bot - Summary',
            text: summaryText
        };
    ...
    async sendLossEmail(asset) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'Random Even/Odd Multi_Asset_Bot - Loss Alert',
            text: summaryText
        };
    ...
    async sendErrorEmail(errorMessage) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'Random Even/Odd Multi_Asset_Bot - Error Report',
