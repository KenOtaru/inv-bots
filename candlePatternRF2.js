...
// ║   Volatility Index | CALLE/PUTE | Candle Pattern Analysis                ║
...
const DEFAULT_CONFIG = {
  ...
  symbol:        'stpRNG',
  tickDuration:  56, // seconds (trade duration)
  initialStake:  0.35,
...
const STATE_FILE          = path.join(__dirname, 'ST2-grid-state-pattern-v2.json');
